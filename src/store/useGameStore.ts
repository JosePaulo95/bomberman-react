...
export const useGameStore = create<State>()(
  ...
  subscribeWithSelector((set, get) => ({
    game: { players: {}, currentScreen: "lobby", totalLevels: 5, currentLevelIndex: 1, timeLeft: 0, gameStartedAt: 0, monsters: [], terrainMap: {map: [], level: 0, playerPositions: [], monsters: []}, bombsMap: [], explosions: [] },
    playerDetails: {},
